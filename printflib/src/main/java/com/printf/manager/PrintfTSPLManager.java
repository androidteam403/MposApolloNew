...
public class PrintfTSPLManager {
    ...
    /**
     * send data
     * -1: Data transmission failed, Bluetooth is not connected
     * 1: Data sent successfully
     * -2: Data transmission failed, exception is thrown, failure
     */
     ...
     * @param fontWidth  font width 1-10
     * @param fontHeight font height 1-10
     ...
     * Print barcode
     *
     * @param x                barcode x coordinate
     * @param y                barcode y coordinate
     ...
     * @param narrow           narrow bar code scaling factor, which can be used to adjust the bar code width
     * @param barcodeTextAlign barcode text position
     *                         NONE: 0,
     *                         LEFT: 1,
     *                         CENTER: 2,
     *                         RIGHT: 3,
     ...
     */
    /**
     * @param x        QR code x coordinate
     * @param y        QR code y coordinate
     * @param level    LEVEL: {
     *                 L: "L",
     *                 M: "M",
     *                 Q: "Q",
