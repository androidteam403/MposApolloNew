...
import com.apollopharmacy.mpospharmacistTest.databinding.SearchCutomerDetailsBinding;
...
public class SearchCustomerDoctorDetailsActivity extends BaseActivity implements SearchCustomerDoctorDetailsMvpView {
    ...
    protected void setUp() {
        ...
        if(customerDetailsMvpPresenter.enablescreens()) {
    ...
    public void onContinueBtnClick() {
        System.out.println("working Oncontinue button--->");
