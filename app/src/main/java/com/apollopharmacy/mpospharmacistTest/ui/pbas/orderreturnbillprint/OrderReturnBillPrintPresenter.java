...
import com.apollopharmacy.mpospharmacistTest.ui.pbas.orderreturnactivity.FeedBackDialog;
...
public class OrderReturnBillPrintPresenter<V extends OrderReturnBillPrintMvpView> extends BasePresenter<V>
        implements OrderReturnBillPrintMvpPresenter<V> {

    @Inject
    public OrderReturnBillPrintPresenter(DataManager manager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable) {
