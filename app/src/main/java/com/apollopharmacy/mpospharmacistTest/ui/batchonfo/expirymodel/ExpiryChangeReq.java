package com.apollopharmacy.mpospharmacistTest.ui.batchonfo.expirymodel;
...
public class ExpiryChangeReq implements Serializable {

    @Expose
    @SerializedName("BatchList")
    private List<BatchListExpiryObj> BatchList;
    ...
    public List<BatchListExpiryObj> getBatchList() {
        return BatchList;
    }

    public void setBatchList(List<BatchListExpiryObj> batchList) {
        BatchList = batchList;
    }
    ...
    public static class BatchListExpiryObj extends BaseObservable implements Serializable {
        @Expose
