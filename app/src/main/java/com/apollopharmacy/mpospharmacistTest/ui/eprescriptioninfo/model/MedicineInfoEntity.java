...
public class MedicineInfoEntity extends BaseObservable implements Serializable
{
  ...
  //  @Expose
   // @SerializedName("Additionaltax")
    private boolean Reqqtyflag;

    public boolean getReqqtyflag() {
        return Reqqtyflag;
    }

    public void setReqqty(boolean reqqtyflag) {
        Reqqtyflag= reqqtyflag;
    }
...
//        }
    ...
    public void setReqQty(double ReqQty1) {
        ReqQty = ReqQty1;
    }
