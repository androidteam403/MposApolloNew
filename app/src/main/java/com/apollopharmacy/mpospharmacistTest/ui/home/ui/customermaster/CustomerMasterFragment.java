...
import com.apollopharmacy.mpospharmacistTest.databinding.FragmentCustMasterBinding;
...
public class CustomerMasterFragment extends BaseFragment implements CustomerMasterMvpView, MainActivity.UserIneractionListener, MainActivity.OnBackPressedListener {
    ...
    public void onSubmitClick() {
        if (validate()) {
            // showOTPPopUp();
            Log.d("Mobile number-->",fragmentCustMasterBinding.mobile.getText().toString());
            mPresenter.sendSmsservice(fragmentCustMasterBinding.mobile.getText().toString());
    ...
    //Otp View functionality...
    @Override
    public void showOTPPopUp(String otp) {
        OTPDialog dialogView = new OTPDialog(getContext());
