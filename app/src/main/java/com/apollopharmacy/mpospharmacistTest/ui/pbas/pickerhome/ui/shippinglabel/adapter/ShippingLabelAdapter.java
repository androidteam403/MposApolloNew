            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (GetJounalOnlineOrderTransactionsResponse row : tempGetJounalOnlineOrderTransactionsResponseList) {
                        if (!filteredGetJounalOnlineOrderTransactionsResponseList.contains(row) && (row.getRefno().toLowerCase().contains(charString.toLowerCase()) || row.getReciptId().toLowerCase().contains(charString.toLowerCase()) || row.getBoxId().toLowerCase().contains(charString.toLowerCase()))) {
