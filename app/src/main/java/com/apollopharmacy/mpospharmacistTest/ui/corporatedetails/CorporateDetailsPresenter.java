...
//                getMvpView().checkFileAvailability();
    ...
    //Get ONline Order Corporate List......
    @Override
    public void getOnlineOrderCorporateList(GetOnlineCorporateListApiRequest request) {
        if (getMvpView().isNetworkConnected()) {
            getMvpView().showLoading();
            ...
            call.enqueue(new Callback<GetOnlineCorporateListApiResponse>() {
                ...
                public void onResponse(@NotNull Call<GetOnlineCorporateListApiResponse> call, @NotNull Response<GetOnlineCorporateListApiResponse> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        getMvpView().hideLoading();
                        getMvpView().SuccessOnlineorderCorporatelist(response.body());
                    } else {
                        getMvpView().hideLoading();
                        if (response.body() != null) {
                        }
    ...
    @Override
    public void onlineordercorporate() {
