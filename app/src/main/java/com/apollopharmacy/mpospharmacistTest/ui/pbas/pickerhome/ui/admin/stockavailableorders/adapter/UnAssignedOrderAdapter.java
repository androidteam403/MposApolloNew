...
public class UnAssignedOrderAdapter extends RecyclerView.Adapter<UnAssignedOrderAdapter.ViewHolder> {
    private final Context context;
    private List<GetOMSTransactionHeaderResponse.OMSHeader> unAssignedOrders;
    private StockAvailableOrdersMvpView mvpView;

    public UnAssignedOrderAdapter(Context context, List<GetOMSTransactionHeaderResponse.OMSHeader> unAssignedOrders, StockAvailableOrdersMvpView mvpView) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        GetOMSTransactionHeaderResponse.OMSHeader omsHeader = unAssignedOrders.get(position);
        ...
        holder.layoutOrderBinding.assignBtn.setVisibility(View.VISIBLE);
        holder.layoutOrderBinding.unAssignBtn.setVisibility(View.GONE);
        holder.layoutOrderBinding.assignedToLayout.setVisibility(View.GONE);
        ...
        holder.layoutOrderBinding.assignBtn.setOnClickListener(view -> {
            mvpView.onClickAssign(omsHeader);
        });
    }
