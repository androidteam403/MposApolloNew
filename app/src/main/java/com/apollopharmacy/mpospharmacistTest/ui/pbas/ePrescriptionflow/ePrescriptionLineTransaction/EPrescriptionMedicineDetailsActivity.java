...
//        detailsBinding.setCallback(mPresenter);
...
//        });
        ...
        detailsBinding.continueBillingBtn.setOnClickListener(new View.OnClickListener() {
            ...
            i.putExtra("ePrescriptionList", (Serializable) prescriptionLineList);
            i.putExtra("medicineResponse", (Serializable) medicineResponseList);
            startActivity(i);
...
//                customerDataResBean.setVendorId("");
...
//
    ...
    @Override
    public void onSubstituteSelectedItem(EPrescriptionSubstituteModelResponse.Substitute substitute, int position) {
