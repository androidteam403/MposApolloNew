...
//    private final OpenOrdersMvpView mvpView;
    ...
    public FullfilmentAdapter(Context context, List<TransactionHeaderResponse.OMSHeader> fullfilmentModelList) {
...
//
//                if (transactionHeaderResponse.getRequestStatus() == 0) {
//                    transactionHeaderResponse.setRequestStatus(1);
//                    holder.fullfilmentBinding.rightArrow.setVisibility(View.GONE);
...
//            @Override
//            public void onClick(View view) {
//                if (transactionHeaderResponse.getRequestStatus() == 1) {
//                    transactionHeaderResponse.setRequestStatus(0);
